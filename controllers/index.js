...
const apiRoutes = require('./api'); // Import the routes defined in the 'api.js' file
...
router.use('/api', apiRoutes); // Use the routes defined in 'api.js' for paths starting with '/api'
